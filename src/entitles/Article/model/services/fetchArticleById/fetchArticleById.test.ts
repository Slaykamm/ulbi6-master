...
const article: Article = {
    id: '1',
    title: 'Hello News',
    subtitle: 'Всем капец, но мы не унываем. Смеемся и плачем!',
    img: 'https://www.pngmart.com/files/12/Hello-Summer-Word-Transparent-Background.png',
    views: 111,
    createAt: '26.02.2022',
    user: {
        id: '1',
...
describe('fetchArticleById.test.ts.test', () => {
    // test('fetchArticleById.test SUCCESS', async () => {
    //     const thunk = new TestAsyncThunk(fetchArticleById);
    //     thunk.api.get.mockReturnValue(Promise.resolve({ article }));
    //     console.log('test222', await thunk.callThunk('1'));
    ...
    test('loginByUsername.test REJECT', async () => {
        ...
        const result = await thunk.callThunk('/articles/2');
