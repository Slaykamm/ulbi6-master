...
import { ArticleCodeComponent } from '../../ArticleCodeComponent/ui/ArticleCodeComponent';
    ...
    if (isLoading) {
        ...
        content = (
            <>
                ...
                <VStack gap="4" max data-testid="AritcleDetails.Info">
                    <Text
                        className={cls.title}
                        title={article?.title}
                    ...
                    <HStack gap="8" className={cls.articleInfo}>
                        ...
                        <Text text={String(article?.createAt)} />
                    </HStack>
                </VStack>
